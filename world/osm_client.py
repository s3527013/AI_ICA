...
class OSMNXClient:
    ...
    This client now includes caching to save/load the graph, speeding up subsequent runs.
    """
    ...
    def __init__(self, place_name):
        ...
        # Define file path for the cached graph
        data_dir = "data"
        ...
        if os.path.exists(filepath):
            ...
            # If no cached graph, download it
            ...
            # Save the processed graph for future use
